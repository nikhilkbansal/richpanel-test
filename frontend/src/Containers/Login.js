...
//   const data =  await fetch('http://localhost:3002/v1/auth/twitter', {
//      method: 'POST',
//      headers: {
...
async function verifyTwitter (query, props, loader) {
  const data = await Fetch('http://localhost:3002/v1/auth/twitter', loader,
    {
...
async function twitterInit (loader) {
  const data = await Fetch('http://localhost:3002/v1/auth/twitter/reverse', loader)
