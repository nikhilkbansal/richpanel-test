...
function NotificationUi({ notification, createdAt, receiverId }) {
  return (
    <View
      style={{
    ...
    >
      <AvatarImage source={{ uri: CommonFunctions.getFile(receiverId && receiverId.picture) }} />
      <View
        style={{
          flex: 4,
