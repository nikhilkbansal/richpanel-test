...
import { View, DatePickerAndroid, TimePickerAndroid, StyleSheet, ScrollView } from 'react-native'
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        >
          <DialogContent
            style={{ width: wp('90%'), position: 'relative', zIndex: 99, height: hp('70%') }}
          >
            ...
            <TextInput
              ...
              onChangeText={this.getAutocompleteResults}
              placeholder="Location..."
            />
            <View style={{ flex: 1, height: hp('20%'), marginTop: hp('2%') }}>
              <MapView
                style={{
                  width: '100%',
                  height: '100%',
            ...
            <ScrollView
              ...
              style={{
                ...
                zIndex: 99999,
                width: '100%',
                elevation: ApplicationStyles.elevationS.elevation,
                maxHeight: hp('30%'),
            ...
            >
              <Text
                style={{ ...ApplicationStyles.body2, width: '100%', padding: wp('1%') }}
                onPress={async () => {
                  alert(3)
                }}
              >
            ...
            <TextInput
              ...
              returnKeyType="next"
            />
            <Button title="Submit" style={styles.loginContainer} />
            {/* </KeyboardAwareScrollView> */}
          </DialogContent>
        </Dialog>
        <Text style={[{ ...ApplicationStyles.fontStyles.body1 }, { padding: 0 }]}>{label}</Text>
        <Button onPress={this.openLocationSelector} style={styles.button}>
          {dateTime ? (
            <Text style={[{ ...ApplicationStyles.fontStyles.body2 }, { padding: 0 }]}>
              {dateTime}
            </Text>
          ) : (
            <Text
              style={[
                { ...ApplicationStyles.fontStyles.body2, ...ApplicationStyles.disabledColor },
                { padding: 0 },
              ]}
            >
              {placeholder}
