...
import { View, StyleSheet, FlatList, Image, ScrollView, StatusBar } from 'react-native'
import {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <NavigationBar
          {...navigation}
          rightButtonAction={() => navigation.navigate('EditProfile')}
          title="Settings"
        />
        ...
        <ScrollView style={styles.subContainer}>
          ...
          <View style={[styles.sectionContainer]}>
            <MenuItem
              rightIcon={{ name: 'ios-arrow-forward', family: 'Ionicons' }}
              leftLabel="FAQs"
            />
          </View>
          <View style={[styles.sectionContainer]}>
        ...
        >
          <Text style={(ApplicationStyles.tabLabelStyle, { textAlign: 'center' })}>
            {' '}
            Handout Version 1.0{' '}
          </Text>
        </View>
